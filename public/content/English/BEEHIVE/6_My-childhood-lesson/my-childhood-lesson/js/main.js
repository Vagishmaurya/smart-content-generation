/**
 * Main JavaScript for My Childhood interactive lesson
 */
...
function startModuleNarration(moduleId) {
    ...
    switch(moduleId) {
        case 'intro':
            if (window.narrator) {
                ...
                if (introModule) {
                    ...
                    let introContent = "Welcome to 'My Childhood'. ";
                    ...
                    window.narrator.speak("Welcome to the interactive English lesson on 'My Childhood'. This is an autobiography by A.P.J. Abdul Kalam about his early years in Rameswaram.");
                }
            }
            break;
        ...
        case 'prereading':
            if (window.narrator) {
                ...
                if (prereadingModule) {
                    ...
                    // Fallback if module not found
                    window.narrator.speak("Welcome to the Let's Begin section. Let's think about scientists who became statesmen and how A.P.J. Abdul Kalam's childhood influenced his later life.");
                }
            }
            break;
        ...
        case 'thinking-language':
            if (window.narrator) {
                window.narrator.speak("Welcome to the Vocabulary and Grammar section. Here you'll explore passive voice from the story.");
            }
            break;
...
function startJourney() {
    ...
    if (narrator) {
        ...
        if (prereadingModule) {
            const contentBlocks = prereadingModule.querySelectorAll('.content-block');
            let prereadingContent = "Welcome to the interactive English lesson on 'My Childhood'. Let's begin by exploring what you know about A.P.J. Abdul Kalam and his early life. ";
            ...
            // Fallback if module not found
            narrator.speak("Welcome to the interactive English lesson on 'My Childhood'. Let's begin by exploring what you know about A.P.J. Abdul Kalam and his early life.");
        }
    }
}
