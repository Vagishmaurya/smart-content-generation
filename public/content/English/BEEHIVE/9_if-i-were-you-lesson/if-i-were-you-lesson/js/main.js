/**
 * Main JavaScript for If I Were You interactive lesson
 */
...
function showModule(moduleId) {
    ...
    if (window.narrator && window.narrator.currentUtterance) {
        ...
        // No need to clear paragraph highlights as the feature has been removed
...
function startModuleNarration(moduleId) {
    ...
    switch(moduleId) {
        case 'intro':
            if (window.narrator) {
                ...
                if (introModule) {
                    ...
                    let introContent = "Welcome to 'If I Were You'. ";
                    ...
                    window.narrator.speak("Welcome to the interactive English lesson on 'If I Were You'. This is a thrilling one-act play about how a person outsmarts a criminal using quick thinking and wit.");
                }
            }
            break;
        ...
        case 'prereading':
            if (window.narrator) {
                ...
                if (prereadingModule) {
                    ...
                    // Fallback if module not found
                    window.narrator.speak("Welcome to the Let's Begin section. Before we read the play, let's understand some important vocabulary that will appear in it.");
                }
            }
            break;
        ...
        case 'thinking-text':
            if (window.narrator) {
                window.narrator.speak("Welcome to the Reading Comprehension section. Here you'll analyze the play and answer questions about it.");
            }
            break;
            
        case 'thinking-language':
            if (window.narrator) {
                window.narrator.speak("Welcome to the Vocabulary and Language section. Here you'll explore how irony is used in the play and improve your dictionary skills.");
            }
            break;
...
function getModuleName(moduleId) {
    switch (moduleId) {
        ...
        case 'thinking-language': return 'Vocabulary & Language';
...
function startJourney() {
    ...
    if (narrator) {
        ...
        if (prereadingModule) {
            const contentBlocks = prereadingModule.querySelectorAll('.content-block');
            let prereadingContent = "Welcome to the interactive English lesson on 'If I Were You'. Let's begin by understanding the vocabulary used in this thrilling play. ";
            ...
            // Fallback if module not found
            narrator.speak("Welcome to the interactive English lesson on 'If I Were You'. Let's begin by understanding the vocabulary used in this thrilling play.");
        }
    }
}
