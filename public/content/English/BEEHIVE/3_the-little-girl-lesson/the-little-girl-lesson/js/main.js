...
function startModuleNarration(moduleId) {
    ...
    switch(moduleId) {
        case 'intro':
            if (window.narrator) {
                ...
                if (introModule) {
                    ...
                    window.narrator.speak("Welcome to the interactive English lesson on 'The Little Girl'. This is a story about how a young girl's feelings for her father change from fear to understanding.");
                }
            }
            break;
        ...
        case 'prereading':
            if (window.narrator) {
                ...
                if (prereadingModule) {
                    ...
                    // Fallback if module not found
                    window.narrator.speak("Welcome to the Let's Begin section. Let's think about how our relationships with our parents change as we grow older.");
                }
            }
            break;
        ...
        case 'thinking-language':
            if (window.narrator) {
                window.narrator.speak("Welcome to the Vocabulary and Grammar section. Here you'll explore synonyms and verbs of reporting from the story.");
            }
            break;
...
function startJourney() {
    ...
    if (narrator) {
        ...
        if (prereadingModule) {
            const contentBlocks = prereadingModule.querySelectorAll('.content-block');
            let prereadingContent = "Welcome to the interactive English lesson on 'The Little Girl'. Let's begin by exploring how relationships change as we grow older. ";
            ...
            // Fallback if module not found
            narrator.speak("Welcome to the interactive English lesson on 'The Little Girl'. Let's begin by exploring how relationships change as we grow older.");
        }
    }
}
