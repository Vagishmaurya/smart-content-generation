...
function startModuleNarration(moduleId) {
    ...
    switch(moduleId) {
        case 'intro':
            if (window.narrator) {
                ...
                if (introModule) {
                    ...
                    window.narrator.speak("Welcome to the interactive English lesson on 'Madam Rides the Bus'. This is a sensitive story about an eight-year-old girl's first bus journey.");
                }
            }
            break;
        ...
        case 'prereading':
            if (window.narrator) {
                ...
                if (prereadingModule) {
                    ...
                    // Fallback if module not found
                    window.narrator.speak("Welcome to the Let's Begin section. Let's explore what you can see from a fast-moving bus.");
                }
            }
            break;
        ...
        case 'thinking-language':
            if (window.narrator) {
                window.narrator.speak("Welcome to the Vocabulary and Grammar section. Here you'll explore vocabulary and language features from the story.");
            }
            break;
...
function startJourney() {
    ...
    if (narrator) {
        ...
        if (prereadingModule) {
            const contentBlocks = prereadingModule.querySelectorAll('.content-block');
            let prereadingContent = "Welcome to the interactive English lesson on 'Madam Rides the Bus'. Let's begin by exploring what you can see from a fast-moving bus. ";
            ...
            // Fallback if module not found
            narrator.speak("Welcome to the interactive English lesson on 'Madam Rides the Bus'. Let's begin by exploring what you can see from a fast-moving bus.");
        }
    }
}
