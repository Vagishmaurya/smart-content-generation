/**
 * Main JavaScript for Nelson Mandela: Long Walk to Freedom interactive lesson
 */
...
function startModuleNarration(moduleId) {
    ...
    switch(moduleId) {
        case 'intro':
            if (window.narrator) {
                ...
                if (introModule) {
                    ...
                    let introContent = "Welcome to 'Nelson Mandela: Long Walk to Freedom'. ";
                    ...
                    window.narrator.speak("Welcome to the interactive English lesson on 'Nelson Mandela: Long Walk to Freedom'. This is an extract from his autobiography about his inauguration as South Africa's first black President.");
                }
            }
            break;
        ...
        case 'prereading':
            if (window.narrator) {
                ...
                if (prereadingModule) {
                    ...
                    // Fallback if module not found
                    window.narrator.speak("Welcome to the Let's Begin section. Let's learn about apartheid and Nelson Mandela's historic role in South Africa's transformation.");
                }
            }
            break;
        ...
        case 'thinking-language':
            if (window.narrator) {
                window.narrator.speak("Welcome to the Vocabulary and Grammar section. Here you'll explore contrasts and balanced structures in Nelson Mandela's writing.");
            }
            break;
...
function startJourney() {
    ...
    if (narrator) {
        ...
        if (prereadingModule) {
            const contentBlocks = prereadingModule.querySelectorAll('.content-block');
            let prereadingContent = "Welcome to the interactive English lesson on 'Nelson Mandela: Long Walk to Freedom'. Let's begin by exploring what you know about apartheid in South Africa. ";
            ...
            // Fallback if module not found
            narrator.speak("Welcome to the interactive English lesson on 'Nelson Mandela: Long Walk to Freedom'. Let's begin by exploring what you know about apartheid in South Africa.");
        }
    }
}
...
// Save a reflection (used in prereading module)
