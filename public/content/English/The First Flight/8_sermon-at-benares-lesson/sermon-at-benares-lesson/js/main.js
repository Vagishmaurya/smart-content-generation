/**
 * Main JavaScript for Sermon at Benares interactive lesson
 */
...
function startModuleNarration(moduleId) {
    ...
    switch(moduleId) {
        case 'intro':
            if (window.narrator) {
                ...
                if (introModule) {
                    ...
                    let introContent = "Welcome to 'The Sermon at Benares'. ";
                    ...
                    window.narrator.speak("Welcome to the interactive English lesson on 'The Sermon at Benares'. This is a story about the Buddha's wisdom regarding suffering and grief.");
                }
            }
            break;
        ...
        case 'prereading':
            if (window.narrator) {
                ...
                if (prereadingModule) {
                    ...
                    // Fallback if module not found
                    window.narrator.speak("Welcome to the Let's Begin section. Let's explore the concept of suffering and how different philosophies approach it.");
                }
            }
            break;
        ...
        case 'thinking-language':
            if (window.narrator) {
                window.narrator.speak("Welcome to the Vocabulary and Grammar section. Here you'll explore the vocabulary and language used in the sermon.");
            }
            break;
...
function startJourney() {
    ...
    if (narrator) {
        ...
        if (prereadingModule) {
            const contentBlocks = prereadingModule.querySelectorAll('.content-block');
            let prereadingContent = "Welcome to the interactive English lesson on 'The Sermon at Benares'. Let's begin by exploring the concept of suffering and how the Buddha approached it. ";
            ...
            // Fallback if module not found
            narrator.speak("Welcome to the interactive English lesson on 'The Sermon at Benares'. Let's begin by exploring the concept of suffering and how the Buddha approached it.");
        }
    }
}
