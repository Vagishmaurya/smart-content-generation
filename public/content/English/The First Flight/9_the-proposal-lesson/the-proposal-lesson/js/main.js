...
function startModuleNarration(moduleId) {
    ...
    switch(moduleId) {
        case 'intro':
            if (window.narrator) {
                ...
                if (introModule) {
                    ...
                    window.narrator.speak("Welcome to the interactive English lesson on 'The Proposal' by Anton Chekhov. This is a one-act play about a marriage proposal that gets derailed by petty arguments.");
                }
            }
            break;
        ...
        case 'prereading':
            if (window.narrator) {
                ...
                if (prereadingModule) {
                    ...
                    // Fallback if module not found
                    window.narrator.speak("Welcome to the Let's Begin section. Let's think about the different meanings of the word 'proposal' and learn about Russian wedding traditions.");
                }
            }
            break;
        ...
        case 'thinking-language':
            if (window.narrator) {
                window.narrator.speak("Welcome to the Vocabulary and Grammar section. Here you'll explore homophones and reported speech from the play.");
            }
            break;
...
function startJourney() {
    ...
    if (narrator) {
        ...
        if (prereadingModule) {
            const contentBlocks = prereadingModule.querySelectorAll('.content-block');
            let prereadingContent = "Welcome to the interactive English lesson on 'The Proposal'. Let's begin by exploring the concept of marriage proposals and Russian wedding traditions. ";
            ...
            // Fallback if module not found
            narrator.speak("Welcome to the interactive English lesson on 'The Proposal'. Let's begin by exploring the concept of marriage proposals and Russian wedding traditions.");
        }
    }
}
