/**
 * Main JavaScript for The Little Girl interactive lesson
 */
...
function startModuleNarration(moduleId) {
    ...
    switch(moduleId) {
        case 'intro':
            if (window.narrator) {
                ...
                if (introModule) {
                    ...
                    let introContent = "Welcome to 'The Little Girl'. ";
                    ...
                    window.narrator.speak("Welcome to the interactive English lesson on 'The Little Girl'. This lesson explores the changing attitude of a girl child towards her father.");
                }
            }
            break;
        ...
        case 'prereading':
            if (window.narrator) {
                ...
                if (prereadingModule) {
                    ...
                    // Fallback if module not found
                    window.narrator.speak("Welcome to the Let's Begin section. Here we'll discuss how you may want to interact with your parents on many issues.");
                }
            }
            break;
        ...
        case 'thinking-language':
            if (window.narrator) {
                window.narrator.speak("Welcome to the Vocabulary and Grammar section. Here you'll explore vocabulary, grammar, and editing exercises.");
            }
            break;
            
        case 'activities':
            if (window.narrator) {
                window.narrator.speak("Welcome to the Activities section. Here you'll practice listening, writing, and work on a project related to the text.");
            }
            break;
...
function startJourney() {
    ...
    if (narrator) {
        ...
        if (prereadingModule) {
            const contentBlocks = prereadingModule.querySelectorAll('.content-block');
            let prereadingContent = "Welcome to the interactive English lesson on 'The Little Girl'. Let's begin by exploring how you may interact with your parents on many issues. ";
            ...
            // Fallback if module not found
            narrator.speak("Welcome to the interactive English lesson on 'The Little Girl'. Let's begin by exploring how you may interact with your parents on many issues.");
        }
    }
}
...
function toggleReadAloud() {
    if (window.narrator) {
        // First ensure user has interacted with the page
        trackUserInteraction();
        
        // Determine current story part
        const activeStoryPart = document.querySelector('.story-part.active');
        if (activeStoryPart) {
            const partId = activeStoryPart.id;
            const partNumber = partId.replace('storyPart', '');
            
            if (partNumber && typeof readStoryPartAloud === 'function') {
                readStoryPartAloud(parseInt(partNumber), true); // true = manual call
            }
        } else {
            window.narrator.speak("Please select a story part to read aloud.");
        }
    } else {
