/**
 * Main JavaScript for Presidents of India interactive lesson
 */
...
function startModuleNarration(moduleId) {
    ...
    switch(moduleId) {
        case 'intro':
            if (window.narrator) {
                ...
                if (introModule) {
                    ...
                    let introContent = "Welcome to 'Presidents of India'. ";
                    ...
                    window.narrator.speak("Welcome to the interactive English lesson on 'Presidents of India'. This lesson explores the Presidents of India, their roles, and contributions to the nation.");
                }
            }
            break;
        ...
        case 'prereading':
            if (window.narrator) {
                ...
                if (prereadingModule) {
                    ...
                    // Fallback if module not found
                    window.narrator.speak("Welcome to the Let's Begin section. Here you'll explore the Presidents of India and their role as First Citizens of the country.");
                }
            }
            break;
        ...
        case 'thinking-language':
            if (window.narrator) {
                window.narrator.speak("Welcome to the Vocabulary and Grammar section. Here you'll explore vocabulary, phrasal verbs, and passive voice from the texts.");
            }
            break;
...
function startJourney() {
    ...
    if (narrator) {
        ...
        if (prereadingModule) {
            const contentBlocks = prereadingModule.querySelectorAll('.content-block');
            let prereadingContent = "Welcome to the interactive English lesson on 'Presidents of India'. Let's begin by exploring the Presidents of India and their role as First Citizens. ";
            ...
            // Fallback if module not found
            narrator.speak("Welcome to the interactive English lesson on 'Presidents of India'. Let's begin by exploring the Presidents of India and their role as First Citizens.");
        }
    }
}
...
function saveWriting() {
    ...
    if (narrator) {
        narrator.speak("Excellent work! Your article has been saved.");
    }
}
...
function recordSpeaking() {
    ...
    if (narrator) {
        narrator.speak("Choose a topic from the list and prepare a brief presentation on it.");
    }
}
...
function playListeningActivity() {
    ...
    if (narrator) {
        narrator.speak("Honourable UN Secretary General Mr Ban Ki-moon, respected President of the General Assembly Vuk Jeremic, honourable UN envoy for global education Mr Gordon Brown, respected elders and my dear brothers and sisters: Assalamu alaikum. Today it is an honour for me to be speaking again after a long time. Being here with such honourable people is a great moment in my life and it is an honour for me that today I am wearing a shawl of late Benazir Bhutto.");
    }
}

// Function for opening writing pad
...
function showResource(resourceId) {
    ...
    if (narrator) {
        switch(resourceId) {
            case 'gandhi-quotes':
                narrator.speak("Here are some famous quotes by Mahatma Gandhi: 'Be the change you wish to see in the world.' 'An eye for an eye only ends up making the whole world blind.' 'The greatness of a nation can be judged by the way its animals are treated.'");
                break;
            case 'kalam-quotes':
                narrator.speak("Here are some inspiring quotes by Dr. A.P.J. Abdul Kalam: 'Dream, dream, dream. Dreams transform into thoughts and thoughts result in action.' 'If you fail, never give up because F.A.I.L. means First Attempt In Learning.' 'Excellence is a continuous process and not an accident.'");
                break;
            case 'mother-teresa-quotes':
                narrator.speak("Here are some heartfelt quotes by Mother Teresa: 'Peace begins with a smile.' 'If you judge people, you have no time to love them.' 'Not all of us can do great things. But we can do small things with great love.'");
                break;
            case 'project-template':
                narrator.speak("This template provides a structure for your project on inspirational quotes, including sections for different personalities, their backgrounds, and their impactful words of wisdom.");
                break;
        }
    }
}
