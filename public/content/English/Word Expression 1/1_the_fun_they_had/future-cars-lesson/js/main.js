/**
 * Main JavaScript for The Future Cars interactive lesson
 */
...
function startModuleNarration(moduleId) {
    ...
    switch(moduleId) {
        case 'intro':
            if (window.narrator) {
                ...
                if (introModule) {
                    ...
                    let introContent = "Welcome to 'The Future Cars'. ";
                    ...
                    window.narrator.speak("Welcome to the interactive English lesson on 'The Future Cars'. This lesson explores future technologies like self-driving cars and drones that are transforming our world.");
                }
            }
            break;
        ...
        case 'prereading':
            if (window.narrator) {
                ...
                if (prereadingModule) {
                    ...
                    // Fallback if module not found
                    window.narrator.speak("Welcome to the Let's Begin section. Here we'll discuss science fiction and future technologies that are becoming reality today.");
                }
            }
            break;
        ...
        case 'thinking-text':
            if (window.narrator) {
                window.narrator.speak("Welcome to the Reading Comprehension section. Here you'll analyze the texts about future technologies and answer questions about them.");
            }
            break;
            
        case 'thinking-language':
            if (window.narrator) {
                window.narrator.speak("Welcome to the Vocabulary and Grammar section. Here you'll explore vocabulary, prefixes, suffixes, and conditional sentences related to the texts.");
            }
            break;
            
        case 'activities':
            if (window.narrator) {
                window.narrator.speak("Welcome to the Activities section. Here you'll practice listening, speaking, and writing skills related to future technologies.");
            }
            break;
...
function getModuleName(moduleId) {
    switch (moduleId) {
        ...
        case 'story': return 'Reading Texts';
...
function startJourney() {
    ...
    showModule('story');
    if (narrator) {
        // Narrate introduction to reading texts
        setTimeout(() => {
            // narrator.speak("Welcome to the interactive English lesson on 'The Future Cars'. Let's begin by reading the texts about future transportation technologies.");
            
            // Automatically start reading the first part of the story after a brief pause
            setTimeout(() => {
                if (typeof readStoryPartAloud === 'function') {
                    readStoryPartAloud(1, false); // false = automatic call
                }
...
function saveWriting() {
    ...
    if (narrator) {
        narrator.speak("Excellent work! Your letter has been saved.");
    }
}
...
function recordSpeaking() {
    ...
    if (narrator) {
        narrator.speak("Think about the technology quotes by Isaac Asimov and George Orwell. Prepare a speech about how these relate to modern technology developments.");
    }
}
...
function playListeningActivity() {
    ...
    alert('In a real implementation, this would play the audio about Self-driving Cars.');
    
    if (narrator) {
        narrator.speak("Self-driving cars, also known as autonomous vehicles, are rapidly evolving from science fiction to reality. Today, we'll explore how these vehicles work, their potential benefits, and the challenges they face.");
    }
}
